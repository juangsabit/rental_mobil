							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('pemesan/tambah') ?>" enctype="multipart/form-data">
								  	<div class="form-group">
								  		...
								  		<input type="text" name="nama" id="nama" required="required" placeholder="Nama Pemesan" autocomplete="off" class="form-control">
								  	</div>
									...
									<div class="form-group">
								  		...
								  		<textarea name="alamat" id="alamat" rows="3" class="form-control" placeholder="Alamat Pemesan"></textarea>
								  	</div>

								  	<div class="form-group">
								  		<label for="foto">Foto Pemesan</label>
								  		<input type="file" name="foto" id="foto" required="required" placeholder="Upload Foto Pemesan" autocomplete="off" class="form-control-file">
