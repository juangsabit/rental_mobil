							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('akun/tambah') ?>" enctype="multipart/form-data">
								  	...
								  	<div class="form-group">
								  		...
								  		<input type="text" name="username" id="username" required="required" placeholder="Masukan Username" autocomplete="off" class="form-control">
								  	</div>
								  	<div class="form-group">
								  	...
								  	<div class="form-group">
								  		...
								  		<input type="file" name="foto" id="foto" required="required" placeholder="Upload Foto" autocomplete="off" class="form-control-file">
